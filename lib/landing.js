(function () {
    ...
    var reservaLanding = {
        ...
        scrollHandler: function (_this) {
            ...
            //brasil
            _this.setClass(position, ".thirteenth-page", ".brasil-full", "encher", -(_this.pageSize * 0.01));
            _this.setClass(position, ".thirteenth-page", ".brasil .fadein-text", "appear", -(_this.pageSize * 0.01));
