(function () {
    ...
    var reservaLanding = {
        ...
        setup: function () {
            ...
            _this.scrollHandler(_this, this);
        ...
        createFifthPage: function (position) {
            var offset = $(".third-page").offset().top + this.pageSize + (this.pageSize / 2);
            var duration = offset + this.pageSize;
            ...
            else if(position > duration && !this.isPorcLessThanZero($(".fifth-page").css("left")))
            {
        ...
        createHorizontalScene: function (position, last, next, trigger) {
            ...
            else if(position > duration && !this.isPorcLessThanZero($(next).css("left")))
            {
                $(next).css("left", '0%');
